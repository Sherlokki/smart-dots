class Population {
    ...
    void update(Obstacle[] obstacles) {
        for (int i = 0; i< dots.length; i++) {
            ...
            if (dots[i].brain.step > minStep + 100) {
    ...
    boolean allDotsDead(Obstacle[] obstacles, ArrayList<HashMap> obstacleLocations) {
        for (int i = 0; i< dots.length; i++) {
        ...
        for (int i = 0; i< obstacles.length; i++) {
            HashMap location = obstacleLocations.get(i);
            obstacles[i].setup((float) location.get("startLocationX"), (float) location.get("startLocationY"), (float) location.get("startVelocityX"), (float) location.get("startVelocityY"));
        }
        return true;
    }
